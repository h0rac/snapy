...
class Snapy:
  ...
  def start_position(self, curr_pos=None, last_pos=None):
...
snapy = Snapy(x =30, y=30, offset=10, jog=1500, sleep=0.5)
...
snapy.start_position(pos, curr_pos)
...
'''
G92 X0 Y0 Z0 B0 X:0.00 Y:0.00 Z:0.00 E:0.00 Count X:35200 Y:25120 Z:105600 B:0
G0 Z0 F1500
ok
